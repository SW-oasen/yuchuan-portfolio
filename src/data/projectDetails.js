    ...
    visuals: [
      {
        ...
        type: "Dashboard",
        src: getImagePath("ai-job-application-assistant/jobs-bewerbungen.png"),
        description: "Hauptseite mit aktuellem Arbeitsstand, Filtern nach Profil, Status und Matching sowie Stichwortsuche.",
      },
      {
        title: "Verwaltung — Stellen importieren",
        type: "Workflow",
        src: getImagePath("ai-job-application-assistant/verwaltung-stellen.png"),
        description: "Zentrale Verwaltung mit Browser-Import, URL-Import und Datenpflege bestehender Stellenanzeigen.",
      },
      {
        title: "Verwaltung — Profil bearbeiten",
        type: "Profile",
        src: getImagePath("ai-job-application-assistant/verwaltung-profil.png"),
        description: "Zentrale Verwaltung von Stammdaten, Zielen, Erfahrung, Skills, Ausbildung und Projekten.",
      },
      {
        title: "Jobdetails und Bewerbungsverlauf",
        type: "Tracking",
        src: getImagePath("ai-job-application-assistant/job-detail.png"),
        description: "Job-Metadaten, Matching-Ergebnis, Bewerbungsstatus und -unterlagen auf einen Blick.",
      },
    ],
  },
  "ai-rag-local": {
