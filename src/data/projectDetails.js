  ...
  "ai-job-application-assistant": {
    ...
    solution: {
      ...
      features: [
        ...
        "Profilspezifisches Matching mit Evidenzklassen, Hybrid Search und sichtbaren Lücken",
        "Getrennter Qualifikations- und Ziel-Fit sowie Portfolio-Projekte als Evidenzquelle",
        "Bearbeitbarer Bewerbungsverlauf mit archivierten Versanddokumenten und CV-Recommender",
    ...
    visuals: [
      {
        title: "Jobs und Bewerbungen",
        type: "Dashboard",
        src: getImagePath("ai-job-application-assistant/übersicht_jobs_bewerbungen.png"),
        description: "Hauptseite mit Statusübersicht, Handlungsempfehlungen, Statusfiltern, Sortierung und Stichwortsuche.",
      },
      {
        title: "Verwaltung — Jobimport und Datenpflege",
        type: "Workflow",
        src: getImagePath("ai-job-application-assistant/verwaltung_job_import.png"),
        description: "Zentrale Verwaltung mit Browser- und URL-Import sowie Suche, Filtern und Datenpflege bestehender Stellenanzeigen.",
      },
      {
        title: "Verwaltung — Profil bearbeiten",
        type: "Profile",
        src: getImagePath("ai-job-application-assistant/verwaltung_profil.png"),
        description: "Profil- und Zielverwaltung mit Arbeitsmodell, Beschäftigungsarten, Ausschlusskriterien und priorisierten Zielrollen.",
      },
      {
        title: "Verwaltung — Praxis & Qualifikationen",
        type: "Profile",
        src: getImagePath("ai-job-application-assistant/verwaltung_praxis_qualifikationen.png"),
        description: "Verwaltung von Berufserfahrung, Projekten, Ausbildung, Zertifikaten und Referenzen als getrennte Evidenzquellen.",
      },
      {
        title: "Jobdetails, Matching und Bewerbung",
        type: "Tracking",
        src: getImagePath("ai-job-application-assistant/job_detail.png"),
        description: "Job-Metadaten, Matching, Prüverlauf, Bewerbungsstatus und -unterlagen sowie CV-Recommender auf einen Blick.",
      },
    ],
  },
  "ai-rag-local": {
  ...
  "energy-price-forecast": {
    ...
    approach: {
      ...
      methodology: [
        ...
        "Automatisierte Datenbeschaffung, Validierung und Speicherung in einer SQLite-Datenbank",
        "Feature Engineering mit Preis-, Nachfrage-, Erzeugungs-, Wetter-, Kalender- und Residuallastmerkmalen",
        "LightGBM-Modelltraining für die stündliche Day-Ahead-Preisprognose",
        "MLflow-Tracking für nachvollziehbare Experimente, Parameter und Modellmetriken",
    ...
    solution: {
      ...
      features: [
        ...
        "LightGBM-Regressor für die stündliche Day-Ahead-Preisprognose",
        "Reproduzierbare Pipeline für Modelltraining, historische Prognosen und Tagesprognosen",
        "Gewichtete Wetteraggregation anhand von Anlagenstandorten und installierter Leistung",
        "MLflow-Tracking für Experimente, Modellparameter und Metriken",
        "Streamlit-Dashboard mit Preisprognose, historischer Vorhersageanalyse und interaktiven Visualisierungen",
      ],
    },
    results: {
      title: "Ergebnisse",
      metrics: [
        { label: "Prognosetyp", value: "Day-Ahead", change: "Deutschland (DE/LU)" },
        { label: "Prognosehorizont", value: "24h", change: "stündlich" },
        { label: "Hauptmodell", value: "LightGBM", change: "Preisvorhersage" },
        { label: "Datenhaltung", value: "SQLite", change: "Zeitreihenpipeline" },
        { label: "Experiment-Tracking", value: "MLflow", change: "Parameter & Metriken" },
        { label: "Anwendung", value: "Streamlit", change: "historisch & Folgetag" },
      ...
      insights: [
        ...
        "Die Zusammenführung von Markt-, Erzeugungs-, Nachfrage- und Wetterdaten schafft die Grundlage für belastbare Preisprognosen",
        "Gewichtete Wetterdaten bilden die geografische Verteilung von Wind- und PV-Anlagen besser ab als einzelne Wetterstationen",
        "Fehlende historische Prognosedaten aus Open-Meteo und SMARD müssen in der Pipeline robust behandelt werden",
        ...
        "Historische Vergleiche und Tagesprognosen machen Modellverhalten und Ergebnisse nachvollziehbar",
      ],
    },
    learnings: {
      title: "Learnings & Reflexion",
      positives: [
        ...
        "Die Behandlung fehlender historischer Open-Meteo- und SMARD-Prognosedaten ist entscheidend für konsistente Trainings- und Bewertungsdaten",
        "Sommer- und Winterzeitumstellungen müssen für stündliche Prognosen explizit modelliert und validiert werden",
        "MLflow schafft eine nachvollziehbare Historie von Experimenten, Parametern und Modellmetriken",
        "Streamlit eignet sich gut, um Modellverhalten, Ausreißer und Plausibilität iterativ zu prüfen",
      ],
      improvements: [
        "Rolling-Window-Training mit festen Drei- oder Vierjahresfenstern als Alternative zum bisherigen Expanding Window evaluieren",
        "Modellvergleich und Ensemble-Ansätze erweitern",
        "Erweiterte Marktmerkmale für die Preisprognose prüfen",
    ...
    visuals: [
      ...
      },
      {
        ...
        type: "ML",
        src: getImagePath("energy-price-forecast/historical-prediction_2.png"),
