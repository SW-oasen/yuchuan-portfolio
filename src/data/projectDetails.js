...
export const PROJECT_DETAILS = {
  ...
  "ai-agent-core": {
    title: "Local AI Agent Core \u2014 kontrollierbarer Agentendienst f\u00fcr lokale LLMs",
    date: "2026-09",
    duration: "Fortlaufend entwickelt",
    status: "Aktiv weiterentwickelt",
    problem: {
      title: "Problem",
      content: "Lokale KI-Anwendungen ben\u00f6tigen einen wiederverwendbaren Agentenkern, der Sprachmodelle und Werkzeuge sicher verbindet, ohne von einer konkreten Benutzeroberfl\u00e4che abh\u00e4ngig zu sein. Tool-Aufrufe, aktuelle Informationen und externe Inhalte m\u00fcssen dabei kontrollierbar, abbrechbar und nachvollziehbar bleiben.",
      challenges: [
        "Lokale, OpenAI-kompatible LLM-Endpunkte hinter einer klaren Agenten-API vereinheitlichen",
        "Mehrstufige Tool-Aufrufe mit Streaming und Abbruch pro Run robust steuern",
        "Externe Webinhalte gegen Prompt Injection, SSRF und unerw\u00fcnschte Netzwerkziele absichern",
        "Aktuelle oder offizielle Fakten nur mit angemessener Recherche und Quellen behandeln",
        "Datei-, Repository- und Kalenderzugriffe auf die konfigurierte lokale Umgebung begrenzen",
      ],
    },
    approach: {
      title: "Daten & Ansatz",
      dataset: "Lokale Chat-Nachrichten, optionale SQLite-Historie, eigene Dokumente sowie gezielt abgerufene externe Informationen. LLMs laufen \u00fcber einen lokal erreichbaren, Ollama-kompatiblen Endpunkt; Tools werden nur nach Policy und innerhalb konfigurierter Grenzen ausgef\u00fchrt.",
      methodology: [
        "Eine unabh\u00e4ngige FastAPI-Schnittstelle f\u00fcr Health, Tool-\u00dcbersicht, Chat, Streaming und Cancellation bereitstellen",
        "Den Agenten als mehrstufigen Planungs- und Ausf\u00fchrungsablauf mit begrenzter Anzahl an Tool-Schritten implementieren",
        "Tools \u00fcber ein Registry- und Policy-Modell f\u00fcr RAG, Suche, Scraping, Wetter, Kalender, Dateien und Repositories anbinden",
        "Tool-Inhalte vor der Verarbeitung als Daten behandeln und mit Prompt-Injection-Schutz versehen",
        "Web-Scraping auf \u00f6ffentliche Ziele beschr\u00e4nken und private, lokale sowie reservierte Netzwerkbereiche blockieren",
        "Freshness- und Quellenregeln f\u00fcr zeitkritische beziehungsweise offizielle Fakten anwenden",
        "SSE-Events f\u00fcr Fortschritt und Antworten ausgeben sowie laufende Runs kooperativ abbrechen",
      ],
      tools: ["Python", "FastAPI", "Ollama", "SQLite", "SearXNG", "HTTP/SSE", "pytest"],
    },
    solution: {
      title: "L\u00f6sung",
      content: "Der Local AI Agent Core ist ein eigenst\u00e4ndig lauff\u00e4higer HTTP-/SSE-Dienst f\u00fcr lokale LLMs. Er nimmt Chat-Anfragen entgegen, w\u00e4hlt nach klaren Regeln zul\u00e4ssige Werkzeuge und liefert Antworten sowie Fortschritt als Stream. Der Core kann im Standalone-Modus lokale Historie verwalten oder innerhalb der AI Agent Platform vom Conversation Orchestrator und dem plattformweiten Memory-Service genutzt werden.",
      features: [
        "OpenAI-kompatible Anbindung lokaler LLMs wie Ollama, llama.cpp und vLLM",
        "REST- und SSE-Endpunkte f\u00fcr Chat, Streaming, Health, Tool-\u00dcbersicht und Run-Cancellation",
        "Mehrstufiges Tool-Calling mit konfigurierbarer Obergrenze",
        "RAG-, Websuche-, Web-Scraping-, Wetter-, Kalender-, Datei- und Repository-Tools",
        "Lokale SQLite-Historie im Standalone-Modus",
        "Prompt-Injection-Abwehr sowie Freshness- und Quellenregeln",
        "Lokale Bindung an 127.0.0.1 und begrenzter Zugriff auf Dateien und Netzwerke",
      ],
    },
    results: {
      title: "Ergebnisse",
      metrics: [
        { label: "Betriebsmodell", value: "Local-first", change: "Ollama-kompatible LLMs" },
        { label: "Schnittstelle", value: "HTTP / SSE", change: "Chat, Streaming & Cancellation" },
        { label: "Tool-Kette", value: "Mehrstufig", change: "Policy-gesteuert" },
        { label: "Historie", value: "SQLite", change: "optional im Standalone-Modus" },
        { label: "Webzugriff", value: "Begrenzt", change: "SearXNG & gesch\u00fctztes Scraping" },
        { label: "Integration", value: "Entkoppelt", change: "optional Teil der AI Agent Platform" },
      ],
      insights: [
        "Ein eigenst\u00e4ndiger Agentendienst kann von Web-, Voice- oder anderen Clients wiederverwendet werden.",
        "Streaming und Run-basierte Cancellation sind f\u00fcr transparente, unterbrechbare Tool-Workflows entscheidend.",
        "Eine Tool-Policy verbindet Erweiterbarkeit mit nachvollziehbaren Sicherheitsgrenzen.",
        "Lokale Ausf\u00fchrung und kontrollierter Webzugriff lassen sich sinnvoll kombinieren.",
      ],
    },
    learnings: {
      title: "Learnings & Reflexion",
      positives: [
        "Die Trennung von Agentenkern und Benutzeroberfl\u00e4che macht die Komponente in verschiedenen Anwendungen nutzbar.",
        "Ein einheitlicher Tool-Lifecycle vereinfacht Tests, Fehlerbehandlung und Erweiterungen.",
        "Sicherheitsgrenzen f\u00fcr Tool-Inhalte und Netzwerkzugriffe sind konkret implementierbar.",
        "Die optionale Plattformintegration bewahrt die eigenst\u00e4ndige Nutzbarkeit des Core.",
      ],
      improvements: [
        "Weitere Integrations- und Lasttests gegen unterschiedliche lokale Modellserver ausbauen.",
        "Tool-Auswahl und Quellenbewertung mit zus\u00e4tzlichen Evals systematisch messen.",
        "Voice-Anbindung \u00fcber den gemeinsamen Turn-Lifecycle der Plattform weiterentwickeln.",
      ],
    },
    resources: {
      repo: "https://github.com/SW-oasen/ai_agent_core",
    },
    visuals: [],
  },
  "ai-document-service": {
